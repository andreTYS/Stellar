...
<div class="page-content">
  <div class="stats-grid">
    <div class="stat-card"><div class="stat-icon">👨‍🎓</div><div class="stat-value" style="color:var(--blue);"><?= $stats['total_estudiantes'] ?></div><div class="stat-label">Estudiantes activos</div></div>
    <div class="stat-card"><div class="stat-icon">✅</div><div class="stat-value" style="color:var(--green);"><?= $stats['modulos_completados'] ?></div><div class="stat-label">Módulos completados</div></div>
    <div class="stat-card"><div class="stat-icon">📁</div><div class="stat-value" style="color:var(--purple);"><?= $stats['entregables'] ?></div><div class="stat-label">Entregables subidos</div></div>
    <div class="stat-card"><div class="stat-icon">🎓</div><div class="stat-value" style="color:var(--gold);"><?= $stats['certificados'] ?></div><div class="stat-label">Certificados emitidos</div></div>
  </div>
